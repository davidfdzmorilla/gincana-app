...
const AsideAdmin = () => {
  ...
  return (
    <aside className="z-9999 bg-gray-800 text-white flex flex-col md:w-64 w-full h-16 md:h-screen fixed md:top-0 md:left-0 bottom-0 left-0">
      ...
      <nav className="flex grow md:flex-col flex-row justify-around w-full md:justify-end p-4 gap-y-8">
        ...
        <Link
          ...
          className="md:mb-2 text-gray-300 hover:text-white text-center md:text-left"
        >
          <RiUserUnfollowFill className="inline" size={30} />
        </Link>
        <Link
          to="/dashboard/chrono"
          className="md:mb-2 text-gray-300 hover:text-white text-center md:text-left"
